...
console.log(4===7); //shows error because it is false
console.log(9===9);
...
let FruitIs:string = 'mangos';
const packing:string = 'Huge boxes';
...
const surveyOn = 'Eight may'  // redeclaration error show
